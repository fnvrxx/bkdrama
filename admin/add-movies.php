...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($deskripsi) || empty($genre)) {
        ...
        try {
            ...
            if ($stmt->execute()) {
                header("Location: manage-movies.php?success=added");
                exit();
            } else {
        ...
        <div class="form-container">
            <form method="POST" action="" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="rilis_tahun" name="rilis_tahun" min="1900"
                            ...
                            value="<?php echo htmlspecialchars($rilis_tahun ?? date('Y')); ?>" required>
                    </div>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn btn-primary">💾 Simpan Drama</button>
